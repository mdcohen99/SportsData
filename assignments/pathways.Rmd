...
coaching_positions <- c(
  ...
  "Assistant Coach",
  "REPLACE ME"  # Fill in: What other coordinator role involves coaching?
)
...
head_coach_with_previous <- coaching_roles |>
  ...
  filter(next_position == "REPLACEME")  # EXERCISE: Fill in the position type
...
transitions_to_head_coach <- transition_frequencies |>
  filter(str_detect(transition, "→ ___________"))  # EXERCISE: Fill in
