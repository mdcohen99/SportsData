...
```{r}
positions_standardized <- read_csv("~/GitHub/Grad School Repos/Fall 2025/Sports Data/SportsData/data/positions_standardized.csv")
```
...
Becoming a head coach is a bit of a difficult circle to get into. Out of about 3,100 total results in this search, 1,184 people were a head coach already before becoming a head coach at a new school. While a plurality of this data shows that the most common position before becoming a head coach is being an assistant, it isn't a huge margin over a head coach moving laterally. Head coaches move around, and finding spots for first time head coaches is hard, as shown by the margins in this data. 
...
I don't believe its valuable. First, most of the names on this list are pretty foreign. The biggest names in women's basketball coaching don't show up. So the trend clearly isn't in favor of needing to be a recruiting coordinator. Just because you were a recruiting coordinator doesn't mean you are necessarily a more skilled recruiter than someone who isn't. I'd say Dawn Staley has done a pretty decent job at recruiting, and she's not on here. Lindsey Gottlieb same thing. 

I would want to ask players what, to them, makes a good recruiter. What do players see in their potential head coaches that make some stand out relative to others in terms of their recruitment skills. And then compare those qualitative answers to the data we have here. 
...
First, the most common career path starts as an assistant coach. In 46 cases, a coach came in right as a head coach and didn't have another job after. So that is possible, but definitely not common relative to starting out as an assistant coach and working up. 

It seems most careers last about three-or-four jobs. I'm intrigued by the scenario of assistant coach, head coach, assistant coach. That is likely a hot shot assistant in their first job getting promoted and then flaming out and back to an assistant. How long does that cycle usually take? I'd imagine not too long. 
...
1) Head coach to assistant coach is always fun, a nice story of demotion (likely beign fired)
2) Head coach to interim head coach. What? Why? Fired but not really? 
3) Head coach to recruiting coordinator. Will someone please do this to Mike Locksley? 
4) Would love to know about the people who skipped from player development or strength coaches right to head coach in their next jobs. 
